...
namespace 五通道自动测试.Calibration
{
    ...
    public class CalibrationAddressCalculator8
    {
        ...
        private int[] _db36AddrDec = new int[33]; // 36db模式地址数组
        private string[] _db36Addr = new string[33]; // 36db模式地址字符串数组
        ...
        /// <summary>
        /// 根据当前选择的频率和温度索引计算八通道36db模式地址
        /// 36db起始地址 = 8192*2 + 24000 + (64 * 31) * (fre - 1) + 64 * (tem - 1) + 1
        /// </summary>
        /// <param name="frequencyIndex">频率索引 (1-4)</param>
        /// <param name="temperatureIndex">温度索引 (1-31)</param>
        public void CalculateDb36Addresses(int frequencyIndex, int temperatureIndex)
        {
            ...
            int db36StartAddress = 40384 + (64 * 31) * (fre - 1) + 64 * (tem - 1) + 1;
        ...
        /// <summary>
        /// 获取当前频率和温度下，特定地址索引对应的八通道36db模式地址
        /// </summary>
        /// <param name="index">地址索引</param>
        /// <returns>十六进制格式的地址字符串</returns>
        ...
        /// <summary>
        /// 获取当前频率和温度下，特定地址索引对应的八通道36db模式十进制地址值
        /// </summary>
        /// <param name="index">地址索引</param>
        /// <returns>十进制地址值</returns>
